...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            img_dir='patches_512_split/images/training',
            ann_dir='patches_512_split/annotations/training_background',
            img_suffix='.png',
            seg_map_suffix='.tif', # 
...
model = dict(
    type='EncoderDecoder',
    pretrained='pretrained/segformer_b0_backbone_weights.pth',
    backbone=dict(
        type='mit_b0',
        style='pytorch'),
    decode_head=dict(
